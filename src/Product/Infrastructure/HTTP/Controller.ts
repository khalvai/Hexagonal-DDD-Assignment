...
import { SwaggerApiResponse } from 'src/Common/Infrastructure/SwaggerDecorator'
...
export class ProductController {
	...
	@SwaggerApiResponse({ dto: ProductReadModel, isArray: true, success: true, statusCode: HttpStatus.OK })
	@UseGuards(AuthGuard)
	@Get('/getAll')
	...
	@SwaggerApiResponse({ message: ProductResponseMessages.PRODUCTS_ARE_DELETED, success: true })
	@UseGuards(AuthGuard)
	@Delete('/deleteAll')
